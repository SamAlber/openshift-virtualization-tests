...
HCO_WORKLOAD_UPDATE_STRATEGY_BASE_PATH = ["virtualization", WORKLOAD_UPDATE_STRATEGY_KEY_NAME]

CUSTOM_WORKLOAD_STRATEGY_SPEC = {
    "spec": {"virtualization": {WORKLOAD_UPDATE_STRATEGY_KEY_NAME: CUSTOM_WORKLOAD_UPDATE_STRATEGY}}
}
